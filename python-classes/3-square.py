...
The class also provides methods for calculating the area of the square.

Example:
    You can create an instance of the `Square` class by specifying its size and calculate
    the area of the square. You can also get and set the size using property getters and setters.
